        ...
        <div className="education" ref={degreesRef}>
          ...
          <div className={`degree ${isVisible ? 'animate' : ''}`}>
            ...
            <div className="degree-info">
              ...
              <h4 className="degree-name">B.Sc. - Biology &amp; Society</h4>
          ...
          <div className={`degree ${isVisible ? 'animate' : ''}`}>
            ...
            <div className="degree-info">
              ...
              <h4 className="degree-name">M.Sc. - Public Health</h4>
              <p className="degree-description">
          ...
          <div className={`degree ${isVisible ? 'animate' : ''}`}>
            ...
            <div className="degree-info">
              ...
              <h4 className="degree-name">Ph.D. - Health Services Research</h4>
              <p className="degree-description">
