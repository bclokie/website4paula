...
const ToolsandModels = () => {
  ...
  return (
    <div className="tools-methods-container">
      <div className="tools-methods-title-container">
        <h2 className="tools-methods-title">Tools and Models</h2>
        <div className="tools-methods-header-line"></div>
      </div>

      {/* Section 1: Behavioral Design Thinking Approach */}
      <div className="tools-methods-section-container">
        <h3 className="tools-methods-section-title">Behavioral Design Thinking Approach</h3>
        <p className="tools-methods-section-subtitle">
        ...
        <div className="tools-methods-work-items">
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM1-1.png")}>
            <h3>Playbook</h3>
            <img src="/TM1-1.png" alt="Playbook" />
            <p>Behavioral Design Thinking</p>
          </div>
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM1-2.png")}>
            <h3>Model</h3>
            <img src="/TM1-2.png" alt="Model" />
            <p>Design Methods for “Effectively Engaging” Digital Health Interventions</p>
          </div>
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM1-3.png")}>
            <h3>Insights</h3>
      ...
      <div className="tools-methods-section-container">
        <h3 className="tools-methods-section-title">Behavioral Design Tools</h3>
        <p className="tools-methods-section-subtitle">
        ...
        <div className="tools-methods-work-items">
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM2-1.png")}>
            <h3>Toolkit</h3>
            <img src="/TM2-1.png" alt="Toolkit" />
            <p>Types of Behavioral Design Tools</p>
          </div>
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM2-2.png")}>
            <h3>Guidance</h3>
            <img src="/TM2-2.png" alt="Guidance" />
            <p>How to Select Behavioral Design Tools</p>
          </div>
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM2-3.png")}>
      ...
      <div className="tools-methods-section-container">
        <h3 className="tools-methods-section-title">Co-Designing Behaviour Change Interventions</h3>
        <p className="tools-methods-section-subtitle">
        ...
        <div className="tools-methods-work-items">
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM3-1.png")}>
            <h3>Playbook</h3>
            <img src="/TM3-1.png" alt="Playbook" />
            <p>Co-Design Process for Maximal Value</p>
          </div>
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM3-2.png")}>
            <h3>Insights</h3>
      ...
      <div className="tools-methods-section-container">
        <h3 className="tools-methods-section-title">Strategic Behavioural Analysis</h3>
        <p className="tools-methods-section-subtitle">
        ...
        <div className="tools-methods-work-items">
          <div className="tools-methods-work-item" onClick={() => handleImageClick("/TM4-1.png")}>
            <h3>Playbook</h3>
      ...
      <Link to="/contact" className="tools-methods-updates-button">
        Contact Me!
      </Link>
      
      {/* Overlay for the clicked image */}
      {clickedImage && (
        <div className="tools-methods-overlay" onClick={() => setClickedImage(null)}>
          <img src={clickedImage} alt="Expanded" className="tools-methods-expanded-image" />
        </div>
      )}
    </div>
  );
